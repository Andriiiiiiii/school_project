...
REMINDER_START = os.getenv("REMINDER_START", "00:40")  # Формат "HH:MM" или "HH:MM:SS" - ИЗМЕНЕНО для 10:00
DURATION_HOURS = float(os.getenv("DURATION_HOURS", 1)) # ИЗМЕНЕНО на 10 часов (с 10:00 до 20:00)
