...
DURATION_HOURS = float(os.getenv("DURATION_HOURS", 10))  # Например, 1 или 3 часов
...
SERVER_TIMEZONE = os.getenv("SERVER_TIMEZONE", "Europe/Moscow")  # Часовой пояс сервера (IANA, например, "UTC" или "Europe/Moscow")
