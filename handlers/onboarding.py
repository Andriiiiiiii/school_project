...
async def send_first_words(chat_id, level, words_count, repetitions, bot):
    ...
    try:
        ...
        if result:
            ...
            await bot.send_message(
                chat_id,
                "Для закрепления изученных слов рекомендую пройти *Квиз*. "
                "Это интерактивный тест, который поможет проверить ваши знания.\n\n"
                "Правильно отвеченные слова будут добавлены в ваш личный словарь. "
                "Вы всегда можете пройти квиз, нажав на кнопку «Квиз» в главном меню.",
                parse_mode="Markdown",
